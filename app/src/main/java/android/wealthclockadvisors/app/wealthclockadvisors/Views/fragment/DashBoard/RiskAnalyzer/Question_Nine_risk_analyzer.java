 ...
 */
public class Question_Nine_risk_analyzer extends Fragment implements View.OnClickListener {
    ...
    double sum=0;
    public Question_Nine_risk_analyzer() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_question__nine_risk_analyzer, container, false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.next:
                ...
                Question_ten_risk_analyzer question_ten_risk_analyzer = new Question_ten_risk_analyzer();
                ...
                fragmentTransaction.replace(R.id.frag, question_ten_risk_analyzer, "question_ten_risk_analyzer");
