 ...
 */
public class Question_Six_risk_analyzer extends Fragment implements View.OnClickListener {
    ...
    public Question_Six_risk_analyzer() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_question__six_risk_analyzer, container, false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.next:
                ...
                Question_seven_risk_analyzer question_seven_risk_analyzer = new Question_seven_risk_analyzer();
                ...
                fragmentTransaction.replace(R.id.frag, question_seven_risk_analyzer, "question_seven_risk_analyzer");
